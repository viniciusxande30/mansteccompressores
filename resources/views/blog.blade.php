       ...
       <div class="fx-serve-1-area fix p-relative pt-120 pb-20">
            ...
            <div class="container fx-container-1">
                ...
                <div class="fx-services-page-item">
                    ...
                    <div class="fx-serve-1-slider-item" style="margin-top:30px">
                        <div class="item-img fix img-cover">
                            <img src="assets/img/services/sd-img-1.png" alt="">
                        </div>

                        <div class="content">
                            <h5 class="item-title fx-heading-1 fx-font-500">
                                <a href="{{ url('/') }}/blog/eficiencia-energetica-industrial" aria-label="name">Efici&ecirc;ncia Energ&eacute;tica Industrial: Como Reduzir Custos e Aumentar a Performance</a>
                            </h5>
