                ...
                <div class="fx-services-page-item">
                    ...
                    <div class="fx-serve-1-slider-item" style="margin-top:30px">
                        <div class="item-img fix img-cover">
                            <img loading="lazy" decoding="async" src="{{ URL('/') }}/assets/img/serve/s1-img-2-opt.jpg" alt="Artigo sobre analise de demanda de ar comprimido">
                        </div>

                        <div class="content">
                            <h5 class="item-title fx-heading-1 fx-font-500">
                                <a href="{{ url('/') }}/blog/analise-de-demanda-de-ar-comprimido" aria-label="Abrir artigo sobre analise de demanda de ar comprimido">Analise de Demanda de Ar Comprimido: Como Dimensionar a Producao sem Desperdicios</a>
                            </h5>
                            
                            <a class="item-btn" href="{{ url('/') }}/blog/analise-de-demanda-de-ar-comprimido" aria-label="Abrir artigo sobre analise de demanda de ar comprimido">
                    ...
                    <div class="fx-serve-1-slider-item" style="margin-top:30px">
                        <div class="item-img fix img-cover">
                            <img loading="lazy" decoding="async" src="{{ URL('/') }}/assets/img/serve/s1-img-3-opt.jpg" alt="Artigo sobre deteccao ultrassonica de vazamentos em ar comprimido">
                        </div>

                        <div class="content">
                            <h5 class="item-title fx-heading-1 fx-font-500">
                                <a href="{{ url('/') }}/blog/deteccao-ultrassonica-de-vazamentos" aria-label="Abrir artigo sobre deteccao ultrassonica de vazamentos">Deteccao Ultrassonica de Vazamentos em Ar Comprimido: Como Encontrar Perdas Invisiveis</a>
                            </h5>
                            
                            <a class="item-btn" href="{{ url('/') }}/blog/deteccao-ultrassonica-de-vazamentos" aria-label="Abrir artigo sobre deteccao ultrassonica de vazamentos">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M40 20C40 8.97219 31.0278 -3.92187e-07 20 -8.74228e-07C8.97219 -1.35627e-06 -3.92187e-07 8.97219 -8.74228e-07 20C-1.35627e-06 31.0278 8.97219 40 20 40C31.0278 40 40 31.0278 40 20ZM2.5 20C2.5 10.3503 10.3503 2.5 20 2.5C29.6497 2.5 37.5 10.3503 37.5 20C37.5 29.6497 29.6497 37.5 20 37.5C10.3503 37.5 2.5 29.6497 2.5 20ZM22.1337 27.1338C21.6453 27.6222 20.8544 27.6222 20.3662 27.1338C20.1222 26.8897 20 26.5697 20 26.25C20 25.9303 20.1222 25.6103 20.3662 25.3662L24.4825 21.25L12.5 21.25C11.8091 21.25 11.25 20.6903 11.25 20C11.25 19.3097 11.8091 18.75 12.5 18.75L24.4825 18.75L20.3663 14.6337C19.8778 14.1453 19.8778 13.3544 20.3663 12.8662C20.8547 12.3781 21.6456 12.3778 22.1337 12.8662L28.3837 19.1163C28.8722 19.6047 28.8722 20.3956 28.3837 20.8838L22.1337 27.1338Z" fill="#FC5220"></path>
                                </svg>
                            </a>
                    ...
                    <div class="fx-serve-1-slider-item" style="margin-top:30px">
                        <div class="item-img fix img-cover">
                            <img loading="lazy" decoding="async" src="{{ URL('/') }}/assets/img/serve/s1-img-1-opt.jpg" alt="Artigo sobre recuperacao de calor em compressores de ar">
                        </div>

                        <div class="content">
                            <h5 class="item-title fx-heading-1 fx-font-500">
                                <a href="{{ url('/') }}/blog/recuperacao-de-calor-em-compressores" aria-label="Abrir artigo sobre recuperacao de calor em compressores">Recuperacao de Calor em Compressores de Ar: Como Transformar Desperdicio em Economia</a>
                            </h5>
                            
                            <a class="item-btn" href="{{ url('/') }}/blog/recuperacao-de-calor-em-compressores" aria-label="Abrir artigo sobre recuperacao de calor em compressores">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M40 20C40 8.97219 31.0278 -3.92187e-07 20 -8.74228e-07C8.97219 -1.35627e-06 -3.92187e-07 8.97219 -8.74228e-07 20C-1.35627e-06 31.0278 8.97219 40 20 40C31.0278 40 40 31.0278 40 20ZM2.5 20C2.5 10.3503 10.3503 2.5 20 2.5C29.6497 2.5 37.5 10.3503 37.5 20C37.5 29.6497 29.6497 37.5 20 37.5C10.3503 37.5 2.5 29.6497 2.5 20ZM22.1337 27.1338C21.6453 27.6222 20.8544 27.6222 20.3662 27.1338C20.1222 26.8897 20 26.5697 20 26.25C20 25.9303 20.1222 25.6103 20.3662 25.3662L24.4825 21.25L12.5 21.25C11.8091 21.25 11.25 20.6903 11.25 20C11.25 19.3097 11.8091 18.75 12.5 18.75L24.4825 18.75L20.3663 14.6337C19.8778 14.1453 19.8778 13.3544 20.3663 12.8662C20.8547 12.3781 21.6456 12.3778 22.1337 12.8662L28.3837 19.1163C28.8722 19.6047 28.8722 20.3956 28.3837 20.8838L22.1337 27.1338Z" fill="#FC5220"></path>
                                </svg>
                            </a>
