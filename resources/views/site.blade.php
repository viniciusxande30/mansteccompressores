                                    ...
                                    <div class="fx-hero-2-slider-item-content">
                                        ...
                                        <div class="fx-hero-2-slider-item-btn fix">
                                            <span class="d-inline-block">
                                                <a href="{{ URL('/') }}/contato" aria-label="Entrar em contato com a Manstec" class="fx-pr-btn-1 has-hover-white">
            ...
            <div class="container fx-container-1">
                ...
                <div class="text-center txxaslideup fix">
                    ...
                    <span class="txxaslideup-item ">
                        <a href="{{ url('/') }}/compressores-de-ar" aria-label="Ver area de atuacao da Manstec" class="fx-services-2-btn" style="color:white">Veja nossa área de atuação</a>
                    </span>
                </div>
            </div>
                                    ...
                                    <div class="fx-core-1-slider-item-content">
                                        ...
                                        <div class="btn-wrap fix">
                                            <span class="d-inline-block fx-core-1-slideinup" >
                                                <a href="https://wa.me/351969558556?text=Olá,%20gostaria%20de%20falar%20com%20você!" aria-label="Falar com a Manstec no WhatsApp" class="fx-pr-btn-1">
                            ...
                            <div class="swiper-slide">
                                <div class="fx-core-1-slider-item">
                                    ...
                                    <div class="fx-core-1-slider-item-content">
                                        ...
                                        <div class="title-wrap">
                                            <h2 class="fx-scn-title-2">MANUTENO DE </h2>
                                            <h2 class="fx-scn-title-2">COMPRESSORES DE AR</h2>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="fx-core-1-slider-item">
                                    ...
                                    <div class="fx-core-1-slider-item-content">
                                        ...
                                        <div class="title-wrap">
                                            <h2 class="fx-scn-title-2">SERVIOS PARA</h2>
                                            <h2 class="fx-scn-title-2"> Compressores de Ar</h2>
                                        </div>
                            ...
                            <form action="{{ url('/') }}/send-email-home" method="POST" class="fx-form-1">
                                ...
                                <div class="fx-form-1-box fix txxaslideup">
                                    <span class="txxaslideup-item fx-cube-1">
                                        <button type="submit" aria-label="Enviar mensagem para a Manstec" class="fx-pr-btn-1 ">
                            ...
                            <div class="fx-contact-us-1-content fix">
                                ...
                                <div class="fx-contact-us-1-info-box txxaslideup fix bg-default"  data-background="{{ URL('/') }}/assets/img/contact/c2-box-bg-2.png">
                                    ...
                                    <ul class="info-list txxaslideup-item fx-cube-1" >
                                        ...
                                        <li>
                                            <a href="tel:+351969558556" aria-label="Ligar para emergencia Manstec Portugal">
